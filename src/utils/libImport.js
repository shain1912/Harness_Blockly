...
// opts.both (default true): emit both forms for the ambiguous case. Pass {both:false} for a curated
// set (e.g. the bundled standard library) where the natural single form by `returns` is cleaner and
